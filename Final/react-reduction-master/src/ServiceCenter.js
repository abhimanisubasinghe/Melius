...
import { EmptyLayout, LayoutRoute, MainLayout , ServiceCenterLayout} from 'components/Layout';
      ...
      <BrowserRouter basename={getBasename()}>
        <GAListener>
          <Switch>
            ...
            <ServiceCenterLayout breakpoint={this.props.breakpoint}>
...
export default componentQueries(query)(ServiceCenter);